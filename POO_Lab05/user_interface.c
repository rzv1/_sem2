...
//		printf("ID: %d, Nume: %s, Prenume: %s, Scor: %d\n", get_id(get_participant_by_index(lista, i)), get_nume(get_participant_by_index(lista, i)), get_prenume(get_participant_by_index(lista, i)), get_scor(get_participant_by_index(lista, i)));
//}
//
...
//}
//
//void user_interface_stergere_participant(Lista* lista) {
//	/*
...
//		}
//
//		print_all_participants(filtrare_participanti_dupa_scor(lista, scor));
//
//		break;
//	}
//
...
//
//		case '3': {
//			user_interface_stergere_participant(&lista);
//			break;
//		}
//
//		case '4': {
